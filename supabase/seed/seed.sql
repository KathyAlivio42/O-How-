...
-- ---------------------------------------------------------
-- OPTION GROUPS
-- Every Coffee and Non-Coffee product gets a required "Size" group:
-- Small (12oz, base price) / Medium (16oz, +20) / Large (22oz, +40).
-- ---------------------------------------------------------

-- The 3 products that previously had a 2-tier "12oz"/"16oz" Size group are
-- being relabeled to Small/Medium/Large — that's a rename, not just a value
-- change, so ON CONFLICT (which matches on name) won't clean up the old
-- rows on its own. Remove the old-named options first; the fresh
-- Small/Medium/Large rows are inserted further down.
delete from product_options
where option_group_id in (
  'b1000000-0000-0000-0000-000000000001', -- Spanish Latte / Size
  'b2000000-0000-0000-0000-000000000001', -- Sea Salt Latte / Size
  'b3000000-0000-0000-0000-000000000001'  -- Chocolate Milk / Size
)
and name in ('12oz', '16oz');

insert into product_option_groups (id, product_id, name, is_required, allow_multiple, sort_order) values
  -- Coffee
  ('b1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'Size', true, false, 1), -- Spanish Latte
  ...
  ('b2000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000002', 'Size', true, false, 1), -- Sea Salt Latte
  ('b2000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000002', 'Ice', true, false, 2),

  ('b4000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000003', 'Size', true, false, 1), -- White Mocha Latte
  ('b5000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000004', 'Size', true, false, 1), -- Salted Caramel Coffee
  ('b6000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000005', 'Size', true, false, 1), -- Caffe Latte
  ('b7000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000006', 'Size', true, false, 1), -- Hazelnut Coffee

  -- Non-Coffee
  ('b3000000-0000-0000-0000-000000000001', 'a2000000-0000-0000-0000-000000000001', 'Size', true, false, 1), -- Chocolate Milk
  ...
  ('b8000000-0000-0000-0000-000000000001', 'a2000000-0000-0000-0000-000000000002', 'Size', true, false, 1), -- Strawberry Matcha Milk
  ('b9000000-0000-0000-0000-000000000001', 'a2000000-0000-0000-0000-000000000003', 'Size', true, false, 1), -- Blueberry Milk
  ('ba000000-0000-0000-0000-000000000001', 'a2000000-0000-0000-0000-000000000004', 'Size', true, false, 1), -- Lemon Soda
  ('bb000000-0000-0000-0000-000000000001', 'a2000000-0000-0000-0000-000000000005', 'Size', true, false, 1), -- Passion Fruit Soda
  ('bc000000-0000-0000-0000-000000000001', 'a2000000-0000-0000-0000-000000000006', 'Size', true, false, 1)  -- Milk Passion Fruit Drink
on conflict (id) do update set
...
insert into product_options (option_group_id, name, price_delta, is_default, sort_order) values
  -- Spanish Latte
  ('b1000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('b1000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('b1000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3),
  ...
  -- Sea Salt Latte
  ('b2000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('b2000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('b2000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3),
  ('b2000000-0000-0000-0000-000000000002', 'Less Ice',    0, false, 1),
  ('b2000000-0000-0000-0000-000000000002', 'Regular Ice', 0, true,  2),

  -- White Mocha Latte / Salted Caramel Coffee / Caffe Latte / Hazelnut Coffee
  ('b4000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('b4000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('b4000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3),
  ('b5000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('b5000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('b5000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3),
  ('b6000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('b6000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('b6000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3),
  ('b7000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('b7000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('b7000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3),

  -- Chocolate Milk
  ('b3000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('b3000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('b3000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3),
  ...
  -- Strawberry Matcha Milk / Blueberry Milk / Lemon Soda / Passion Fruit Soda / Milk Passion Fruit Drink
  ('b8000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('b8000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('b8000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3),
  ('b9000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('b9000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('b9000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3),
  ('ba000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('ba000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('ba000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3),
  ('bb000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('bb000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('bb000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3),
  ('bc000000-0000-0000-0000-000000000001', 'Small (12oz)',  0,  true,  1),
  ('bc000000-0000-0000-0000-000000000001', 'Medium (16oz)', 20, false, 2),
  ('bc000000-0000-0000-0000-000000000001', 'Large (22oz)',  40, false, 3)
