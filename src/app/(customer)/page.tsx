...
export default function WelcomePage() {
  ...
  return (
    <main className="min-h-screen flex flex-col justify-center items-center px-6 py-10 max-w-md mx-auto">
      <div className="flex flex-col items-center text-center gap-5">
        <div className="relative h-40 w-40 rounded-full overflow-hidden shadow-card-hover transition-transform duration-300 ease-out hover:scale-110 cursor-pointer">
          <Image
        ...
        <div>
          ...
          <p className="mt-2 text-ink-muted">Sip, smile, repeat.</p>
        </div>
      </div>
